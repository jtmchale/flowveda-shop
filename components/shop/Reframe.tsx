const cards = [
  {
    stat: "200,000",
    unit: "years",
    label: "of survival wiring",
  },
  {
    stat: "100%",
    unit: "",
    label: "ancestral survival success",
  },
  {
    stat: "0",
    unit: "",
    label: "preparation for modern stimuli",
  },
];
      ...
      <div className="fv-container-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          {cards.map((card, i) => (
            <div
              key={i}
              className="bg-white border-[1.5px] border-fv-purple rounded-xl p-9 shadow-fv-card hover:-translate-y-1 hover:shadow-fv-card-hover transition-all duration-200"
            >
